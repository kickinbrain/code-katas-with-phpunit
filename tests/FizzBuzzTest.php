...
class FizzBuzzTest extends TestCase
{
    ...
    function it_returns_for_multiples_of_three()
    {
    ...
    function it_returns_for_multiples_of_five()
    {
    ...
    function it_returns_fizzbuzz_for_multiples_of_tree_and_five()
    {
